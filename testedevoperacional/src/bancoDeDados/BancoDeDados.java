...
public class BancoDeDados {
    ...
    public List<Usuario> usuarios = Arrays.asList(usuario1, usuario2, usuario3, usuario4, usuario5, usuario6);
    public List<Cliente> clientes = Arrays.asList(cliente, cliente2);
    public List<Empresa> empresas = Arrays.asList(empresa, empresa2, empresa3);
    public List<Produto> produtos = Arrays.asList(produto, produto2, produto3, produto4, produto5, produto6, produto7, produto8, produto9, produto10);
}
